...
import com.pubg.smp.smpinfo.client.ClassClient;
import com.pubg.smp.smpinfo.client.LeaveClient;
import com.pubg.smp.smpinfo.client.RoomClient;
import com.pubg.smp.smpinfo.dao.ApartmentDao;
import com.pubg.smp.smpinfo.dao.RoleDao;
import com.pubg.smp.smpinfo.dao.StudentUserDao;
import com.pubg.smp.smpinfo.dao.UserDao;
...
import com.pubg.smp.smpinfo.entity.StudentUser;
import com.pubg.smp.smpinfo.entity.User;
import com.pubg.smp.smpinfo.exception.NullFiledException;
import com.pubg.smp.smpinfo.exception.SecurityException;
import com.pubg.smp.smpinfo.security.LoginUser;
import com.pubg.smp.smpinfo.service.UserService;
import com.pubg.smp.smpinfo.service.impl.excel.ExcelHandlerHelper;
import com.pubg.smp.smpinfo.util.IdCardUtils;
import com.pubg.smp.smpinfo.util.BeanCopyUtils;
...
import static com.pubg.smp.smpinfo.entity.Role.*;
...
public class UserServiceImpl implements UserService {
        ...
        Page<StudentUserDTO> page = userDao.findAll((Specification<User>) (root, query, cb) -> {
            ...
            return cb.and(
                ...
                .map(user -> {
                    ...
                    return BeanCopyUtils.doubleEntity2Dto(user, studentUser, StudentUserDTO.class);
                });
    ...
    public void updateUser(StudentUserDTO studentUserDTO, LoginUser loginUser) {
        ...
        StudentUser studentUser = BeanCopyUtils.a2b(studentUserDTO, StudentUser.class);
        User user = BeanCopyUtils.a2b(studentUserDTO, User.class);
