...
import com.pubg.smp.smpclass.exception.FileException;
...
import com.pubg.smp.smpclass.service.ClassUserService;
import com.pubg.smp.smpclass.util.DateUtils;
import com.pubg.smp.smpclass.util.BeanCopyUtils;
...
public class ClassUserServiceImpl implements ClassUserService {
    ...
    public Page<StudentClassDTO> getAllStudentClass(LoginUser loginUser, Pageable pageable) {
        ...
        return studentClassDao.findByUser(user, pageable).map(studentClass -> {
            StudentClassDTO studentClassDTO = BeanCopyUtils.a2b(studentClass, StudentClassDTO.class);
