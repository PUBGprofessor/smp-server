...
import com.pubg.smp.smpleave.client.InfoClient;
import com.pubg.smp.smpleave.client.entity.StudentUser;
import com.pubg.smp.smpleave.dao.LeaveDao;
import com.pubg.smp.smpleave.dao.LeaveReasonDao;
...
import com.pubg.smp.smpleave.entity.User;
import com.pubg.smp.smpleave.exception.DateRangeException;
import com.pubg.smp.smpleave.exception.NullFiledException;
import com.pubg.smp.smpleave.exception.SecurityException;
import com.pubg.smp.smpleave.exception.UnexpectedException;
import com.pubg.smp.smpleave.security.LoginUser;
import com.pubg.smp.smpleave.service.LeaveService;
import com.pubg.smp.smpleave.util.DateUtils;
import com.pubg.smp.smpleave.util.BeanCopyUtils;
...
import static com.pubg.smp.smpleave.util.DateUtils.*;
...
public class LeaveServiceImpl implements LeaveService {
    ...
    public Page<LeaveDTO> getLeaves(Pageable pageable, Boolean status, LoginUser loginUser) {
        ...
        return leaveDao.findAll((Specification<Leave>) (root, query, cb) -> {
            ...
            Join<User, com.pubg.smp.smpleave.entity.StudentUser> studentUserJoin = userJoin.join("studentUser", JoinType.INNER);
        ...
        return leaveDao.findAll((Specification<Leave>) (root, query, cb) -> {
            ...
            return cb.and(list.toArray(p));
                ...
                .map(leave -> {
                    ...
                    LeaveDTO leaveDTO = BeanCopyUtils.a2b(leave, LeaveDTO.class);
    ...
    public void delLeaveInfo(String counselorUsername, String studentUserName) {
        ...
        com.pubg.smp.smpleave.client.entity.StudentUser studentUser = infoClient.getStudentUserInfoByUserName(studentUserName).orElseThrow(() -> new NullFiledException("学生不存在", HttpStatus.NOT_FOUND));
